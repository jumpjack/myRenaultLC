endpointsList = [
	...
	{ name : "cockpit" , 											url : "cockpit", 																						"payload" : {},			"description" : "Show mileage" 																		,	"response" : [{"name" : "totalMileage"}, {"name":"fuelAutonomy"}, {"name" : "fuelQuantity"}]},
	{ name : "location" , 										url : "location",																						"payload" : {},			"description" : "Show car position"																 , "response" : [{"name" : "gpsLatitude"}, {"name" : "gpsLongitude", }]},
	{ name : "battery-status" , 							url : "battery-status"	,																		"payload" : {},			"description" : "Show battery status  and charging status"				 , "response" : [
	{"name" : "chargeStatus"},
	{"name" : "plugStatus"},
	{"name" : "rangeHvacOn"},
	{"name" : "batteryLevel"},
...
{"name" : "chargingInstantaneousPower"}, ]},
	...
	{ name : "hvac-status" , 									url : "hvac-status",																				"payload" : {},			"description" : "Show if On/off, target temperature, no schedule", "response" : [{"name" : "hvacStatus"}, {"name" : "internalTemperature"}, ]},
	{ name : "hvac-settings" , 								url : "hvac-settings",																			"payload" : {},			"description" : "Show HVAC schedule grouped by id", 								"response" : [{"name" : "mode"}, {"name" : "globalTargetTemperature"},  {"name" : "schedules"}, ]},
	{ name : "hvac-schedule" , 								url : "hvac-schedule",																			"payload" : {},			"description" : "Show HVAC schedule groupd by day", 								"response" : [{"name" : "calendar"}]},
	{ name : "hvac-history" , 								url : "hvac-history?start=20210201&end=20210301&type=day",	"payload":  {},			"description" : "-", 																							"response" : [{"name" : ""}, {"name" : ""},]},
	{ name : "hvac-sessions" , 								url : "hvac-sessions?start=20210201&end=20210301",					"payload" : {},			"description" : "-", 																							"response" : [{"name" : ""}, {"name" : ""},]},
	{ name : "----- Charging -------" ,				url : "",																										"payload" : {},			"description" : ""},
	{ name : "Show current charging mode" , 	url : "charge-mode"	,																				"payload" : {},			"description" : "Show charge mode", 															"response" : [{"name" : "chargeMode"}]},
	{ name : "Show charging settings" ,				url : "charging-settings",																	"payload" : {},			"description" : "Show charge schedule by id", 										"response" : [{"name" : "mode"}, {"name" : "schedules"},]},
	{ name : "Show charge schedule" , 				url : "charge-schedule"	,																		"payload" : {},			"description" : "Show charge schedule by day", 										"response" : [{"name" : "calendar"}]},
	{ name : "Show charge history" , 					url : "charge-history?start=20210101&end=20210201&type=day","payload" : {},			"description" : "Show number of charges and count of kWh", 				"response" : [{"name" : ""}]},
