endpointsList = [
...

	{
		...
		"response" : [
			...
			{"name" : "batteryAvailableEnergy"},
			{
				"name" : "plugStatus",
				"values" : [
					{"number" : 0, "text" : "Disconnected"},
					{"number" : 1, "text" : "Connected"},
			...
			},
			{
				"name" : "chargingStatus",
				"values" : [
				    {"number" : 0.1, "text" : "NOT_IN_CHARGE"},
				    {"number" : 0.2, "text" : "WAITING_FOR_A_PLANNED_CHARGE"},
				    {"number" : 0.3, "text" : "CHARGE_ENDED"},
				    {"number" : 0.4, "text" : "WAITING_FOR_CURRENT_CHARGE"},
				    {"number" : 1.0, "text" : "ENERGY_FLAP_OPENED"},
				    {"number" : -1.0, "text" : "CHARGE_IN_PROGRESS"},
				    {"number" : 1.1, "text" : "CHARGE_ERROR"},
				]
			},
...

	{
		...
		"url" : "charge-history?start=20210101&end=20210201&type=day",
		"payload" : {},
	...
	{
		"name" : "charges",
		"url" : "charges?start=20210101&end=20210201&type=day",
		"payload" : {},
		"description" : ""
	},
...

	{
		...
		"description" : "Refresh battery data retrieved nby  battery-status endpoint"
	},
