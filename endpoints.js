endpointsList = [
	...
	{ name : "----- Experimental ----------" , 	url : "",								"description" : "-"},
	{ name : "lock-status" , 					url : "lock-status"	,					"description" : "-"},
	{ name : "notification-settings" ,			url : "notification-settings",			"description" : "-"},
	{ name : "actions/horn-lights" , 			url : "actions/horn-lights",			"description" : "-"},
	{ name : "actions/engine-start" , 			url : "actions/engine-start",			"payload" : {'data':{'type':'EngineStart','attributes':{'action':'start'}}} , 						"description" : "-"},
	{ name : "actions/send-navigation" , 		url : "actions/send-navigation"	,		"description" : "-"},
];
